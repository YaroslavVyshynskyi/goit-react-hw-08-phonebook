...
import { useGetUserQuery } from "slice/userSlice";
import { authSelectors, setUserAuth } from "slice/authSlice";
          ...
          <BrowserRouter >
            <Suspense fallback={<p>Loading...</p>}>
              ...
              <Routes>
                ...
                <Route path="/registration" element={<PublicRoute restricted redirectTo="/contacts">
                  <RegistrationPage />
                </PublicRoute>} />
                <Route path="/contacts" element={<PrivateRoute restricted redirectTo="/login">
                  <ContactsPage />
                </PrivateRoute>} />
                <Route
                  path="*"
